 ...
 */
package com.netflix.spinnaker.remotestage
...
object MainDefaults {
  val PROPS = mapOf(
    ...
    "spring.application.name" to "remotestage",
...
@ComponentScan(basePackages = ["com.netflix.spinnaker.config", "com.netflix.spinnaker.remotestage.config"])
